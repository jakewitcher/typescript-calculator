...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"computations.ts":[function(require,module,exports) {
"use strict";
...
exports.add = add = function add(a, b) {
  return a + b;
};
...
exports.subtract = subtract = function subtract(a, b) {
  return a - b;
};
...
exports.multiply = multiply = function multiply(a, b) {
  return a * b;
};
...
exports.divide = divide = function divide(a, b) {
  return a / b;
};
